...
const Playbook = () => {
  ...
  if (loading) {
    return (
      <div className="h-screen bg-green-800 flex items-center justify-center" style={{ backgroundColor: '#1a4d3a' }}>
  ...
  return (
    <div className="min-h-screen bg-green-800 p-4" style={{ backgroundColor: '#1a4d3a' }}>
          ...
          <div className="bg-black rounded-lg overflow-hidden mb-8">
            <div className="aspect-video relative flex items-center justify-center">
              <div className="text-white text-center">
                ...
                <p className="text-lg font-medium">Play on Loop</p>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="text-center">
        <h3 className="text-xl font-bold text-white mb-6">Find Your Play</h3>
        
        <div className="grid grid-cols-2 gap-4">
          {/* Formation Block */}
          <div className="bg-white rounded-lg p-8 flex items-center justify-center min-h-[120px]">
            <span className="text-2xl font-bold text-gray-800">Formation</span>
          </div>
          
          {/* Play Type Block */}
          <div className="bg-white rounded-lg p-8 flex items-center justify-center min-h-[120px]">
            <span className="text-2xl font-bold text-gray-800">Play Type</span>
          </div>
        </div>
      </div>
    </div>
