...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-green-800 max-w-sm mx-auto relative" style={{ backgroundColor: '#1a4d3a' }}>
      ...
      {activeTab !== 'home' && (
        <header className="bg-green-900 border-b-2 border-white px-4 py-3 sticky top-0 z-10 relative">
          <div className="flex justify-between items-center">
            ...
            <Button
              ...
              variant="ghost"
              size="sm"
              className="text-white hover:bg-green-700 border border-white"
            >
              <LogOut size={16} />
            </Button>
          </div>
      ...
      <nav className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-sm bg-green-900 border-t-2 border-white relative">
        {/* Chalk dust effect */}
